...
class MarketPlaceService extends StatefulWidget {
  MarketPlaceService({Key? key}) : super(key: key);

  @override
  State<MarketPlaceService> createState() => MarketPlaceServiceState();
}

class MarketPlaceServiceState extends State<MarketPlaceService> {
     ...
     height: kToolbarHeight + MediaQuery.of(context).padding.top,
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text('Services', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 22),),
            ],
          ),
          Row(
            children: [
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: ((context, index) {
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    currentCategory = serviceCategories[index-1];
                                  });
                                },
                                child: Container(
                                  margin: EdgeInsets.all(10),
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                      color: currentCategory == serviceCategories[index-1] ? Colors.teal : Colors.transparent
                                    ),
                                    borderRadius: BorderRadius.circular(15)
                                  ),
                                  child: CategoryCard(category: Category(Colors.white, Colors.white, serviceCategories[index-1], ''))));
                        ...
                        builder: (context, snapshot) {
                          ...
                          switch (snapshot.connectionState) {
                            ...
                            child: RefreshIndicator(
                              key: brakey.refreshServiceMarket.value,
                              onRefresh: () async {
                                  // brakey.reloadUser('');
                          ...
                          if (snapshot.hasData) {
                            ...
                            if (currentCategory == 'All') {
                              sortedProducts = snapshot.data!['SERVICE'];
                            } else {
                              snapshot.data!['SERVICE'].forEach((element) {
                                print(element);
                                if (element['Payload']['service_categories']?['category_1'] == currentCategory) {
                            ...
                            child: RefreshIndicator(
                              ...
                              padding: EdgeInsets.all(20),
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  crossAxisCount: 2),
                                // scrollDirection: Axis.horizontal,
                                itemCount: sortedProducts.length.clamp(0, 8),
                                              ...
                                              child: Center(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height:20),
                                                    Flexible(child: Text(hasLoadError ? loadErrorMsg : "Fetching ${toTitleCase(_templates[index]['Payload']['conntract_title'])}", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey, fontSize: 23),))
                                                  ],
                                                ),
                                              ),
                                            );
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  Image.network(_templates[index]['Payload']['service_picture_links']?['link_1']??'https://firebasestorage.googleapis.com/v0/b/braketpay-mobile-app.appspot.com/o/assets%2Fimages.png?alt=media&token=2ca79fe2-172f-49ab-93bf-a6550ef78fa2', fit: BoxFit.cover, width: double.infinity, height: double.infinity,
                                            ...
                                            Padding(
                                              ...
                                              child: Text(toTitleCase(_templates[index]['Payload']['conntract_title']??''),
                                                  maxLines: 1,
                                                  textAlign:
                                                      TextAlign
                              ...
                              child: Center(
                                    ...
                                    children: [
                                      ...
                                      RoundButton(
                                          ...
                                          onTap: () {
                                            print('hi');
                                            brakey.refreshServiceMarket.value?.currentState?.show();
                                          })
                                    ],
                                  )),
                            );
