                                    ...
                                    DropdownButton(
                                        ...
                                        items: savingsPlan.map((String items) {
                                          ...
                                          return DropdownMenuItem(
                                              value: items, child: RichText(text: TextSpan( children: [TextSpan(text:"$items ", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)), TextSpan(text:"${savingsDetail[items]['range']}", style: TextStyle(color: Colors.black, fontFamily: ''))])));
                                        }).toList(),
