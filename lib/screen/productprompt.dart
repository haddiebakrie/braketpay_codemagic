...
class ProductPrompt extends StatefulWidget {
  ProductPrompt({Key? key, required this.user, required this.creatorType}) : super(key: key);
          ...
          title: Text('${widget.creatorType} Contract'),
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                widget.creatorType == 'Buyer' ? Container(
                  // margin: Ed,
                  // height: 200,
                  child: Stack(
                      ...
                      child: Column(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            _loginButtonController.reset();
                                            } else if (receiverName == 'Looking for user...' || receiverName == 'This username does not match any user' || receiverName == "You can't create a contract with yourself" || receiverName == 'Unknown' || receiverName == 'No Internet access (Tap to retry)' || receiverName == 'No username provided') {
                            _loginButtonController.reset();
