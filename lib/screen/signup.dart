...
class SignUp extends StatefulWidget {
  SignUp({Key? key, required this.email,  required this.phone, required this.payload}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                              child: Text(
                                index ==  0 ? 'Verify OTP\n' : index == 1 ? 'Verify Personal Information' : 'Setup Account \nPassword',
                                style: TextStyle(
                      ...
                      onStepReached: (e) {
                        setState(() {
                          index = e;
                          pageController.animateToPage(e, duration: Duration(milliseconds: 1), curve: Curves.ease);
                        });
                      },
                                      ...
                                      //  
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: 'BVN Phone Confirmation\n',
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                focusedBorder: const OutlineInputBorder(
                                                    ...
                                                    borderRadius:
                                                        BorderRadius.all(Radius.circular(10))),
                                                        hintMaxLines: 5,
                                                hintText: 'Enter the OTP sent to ${widget.email}\n',
                                                  hintStyle: TextStyle(fontWeight: FontWeight.w600),
                                          ...
                                          Container(
                                              ...
                                              child: RoundedLoadingButton(
                                                  ...
                                                  Map a = !widget.payload!.containsKey('firstname') ? await verifyBVN(widget.phone.toString(), widget.email, otp2, otp, '', 'without_bvn') : await verifyBVN(widget.phone.toString(), widget.email, otp2, otp, phoneConfirm,'with_bvn');
                                                          print('ppp$a');
                                                      if (a.containsKey('Payload') || a['Status'] == 'successful' || a['Status'] == 'successfull') {
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(dob,
                                                  style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.white54)),
                                            ),
                                          )
                                        ],
                                      ),
                                            ...
                                            child: RoundedLoadingButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (_formKey.currentState!.validate()) {
                                                    ...
                                                    final dp = await Get.to(() => UploadProfilePicture(cameras: cameras, email: widget.email));
                                                    print(dp);
                                                    print('dp');
                                                    if (dp == null) {
                                                      _loginButtonController.reset();
                                ...
                                borderRadius: BorderRadius.circular(20),
                                                  ...
                                                  final fcmToken = await FirebaseMessaging.instance.getToken();
                                                    ...
                                                    Map a = await createUserAccount(
                                                      fullname,
                                                      widget.phone != '' ? widget.phone.toString() : widget.phone.toString(),
                                                      dob,
                                                      widget.email,
                                                      password,
                                                      phoneConfirm,
